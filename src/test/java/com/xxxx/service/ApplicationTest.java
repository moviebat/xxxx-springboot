...
public class ApplicationTest {
	...
	@Test
	public void testContextLoadsMultiEnvironment() {
		//测试多环境配置
//		System.out.println(student.getName()+"   "+student.getAge());
		assertEquals("张三pro",student.getName());
		assertEquals("30",String.valueOf(student.getAge()));

		//测试多环境的测试环境
//		assertEquals("张三test",student.getName());
//		assertEquals("20",String.valueOf(student.getAge()));
	...
	@Test
	@Ignore
	public void testContextLoadsTransaction(){
